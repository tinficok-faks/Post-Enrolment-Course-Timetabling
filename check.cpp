...
if(argc != 3){
  cout << "Usage: check <timfilename> <filename>" << endl;
  return 1;
}
timfilename = argv[1];
filename = argv[2];
...
if(orderclash+unsuitableslots+unsuitablerooms+studentclashes+roomclashes > 0)
return -orderclash+unsuitableslots+unsuitablerooms+studentclashes+roomclashes;
